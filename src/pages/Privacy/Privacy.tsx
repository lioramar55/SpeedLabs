const Privacy = () => {
  return (
    <div className="privacy-page main-container">
      <h1>Privacy Policy</h1>
      <div className="privacy-content">
        <p>Last updated: December 3, 2024</p>

        <p>
          SpeedLabs built the SpeedLabs app as a Freemium app. This SERVICE is
          provided by SpeedLabs at no cost and is intended for use as is.
        </p>
        ...
        <section>
          ...
          <p>
            ...
            our Terms and Conditions, which are accessible at SpeedLabs unless
        ...
        <section>
          ...
          <p>
            ...
            <a href="mailto:0xrefael@gmail.com">0xrefael@gmail.com</a>
          </p>
        </section>
      </div>
    </div>
